          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between text-xs">
                  <span>完成作业：数学练习</span>
                  <Button size="sm" className="h-5 w-12 bg-yellow-500 hover:bg-yellow-600 text-xs">
                    去完成
                  </Button>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span>观看视频：Python基础</span>
                  <Button size="sm" className="h-5 w-12 bg-blue-500 hover:bg-blue-600 text-xs">
                    去完成
                  </Button>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span>今日打卡签到</span>
                  <Button size="sm" className="h-5 w-12 bg-red-500 hover:bg-red-600 text-xs">
                    去完成
                  </Button>
                </div>
              </div>
            ...
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-xs font-medium">成为讲师</span>
              </div>
              <p className="text-xs text-green-200 mb-2">分享您的知识，获得额外收益</p>
              <Button 
                onClick={onBecomeTutor}
                size="sm" 
                className="w-full bg-white/20 hover:bg-white/30 border-white/30 text-xs h-6"
              >
                立即申请
              </Button>
            </div>
