          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button 
                ...
                size="sm" 
                className="bg-white/20 hover:bg-white/30 border-white/30 text-sm animate-bounce"
              >
            ...
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between text-xs">
                  <span>完成作业：数学练习</span>
                  <Button size="sm" className="h-5 w-16 bg-yellow-500 hover:bg-yellow-600 text-xs">
                    去完成
                  </Button>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span>观看视频：Python基础</span>
                  <Button size="sm" className="h-5 w-16 bg-blue-500 hover:bg-blue-600 text-xs">
                    去完成
                  </Button>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span>今日打卡签到</span>
                  <Button size="sm" className="h-5 w-16 bg-red-500 hover:bg-red-600 text-xs">
                    去完成
                  </Button>
                </div>
              </div>
